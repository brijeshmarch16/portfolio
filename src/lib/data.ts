...
export const portfolio = {
  ...
  profile: {
    ...
    story: [
      "I'm a full-stack developer who builds products end-to-end — from figuring out the problem and designing the experience to writing the frontend, backend, and everything in between.",
      "I started with frontend development, and working on real products pushed me beyond the interface — how APIs work, how data is stored, how authentication is handled, and what makes an application reliable. Since my first developer role in 2021, I've worked on production applications, freelance projects, developer tools, and products involving AI.",
    ],
    social: [
      {
        label: "Email",
